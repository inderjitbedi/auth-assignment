...
module.exports.displayProductList =(req, res, next) => {
    products.find((err, productList) => {
        if (err){
            ...
            res.render('./products/list',{title:'Product List', ProductList : productList,
...
module.exports.displayProductListAdd = (req, res, next) => {
        res.render('./products/add',{title:'Add Products',displayname:req.user?req.user.displayname:''});
...
module.exports.displayProductListEdit =(req, res, next) => {
    ...
    products.findById(id, (err, productListEdit) => {
        if (err) {
            ...
            res.render('./products/edit', { title:'Edit Product', editProduct : productListEdit,
            displayName:req.user?req.user.displayName:''})
        }
    })
